...
public class MailTest extends AbstractBaseTestClass {
	...
	@Test
	@SmtpServer(timeout = 10000, waitFor = { @WaitFor(headers = @Header(key = "Subject", value = "Test23")) })
	...
	@Test(expected = TimeLimitExceededException.class)
	@SmtpServer(timeout = 1000, waitFor = { @WaitFor(headers = @Header(key = "Subject", value = "DoesNotExist")) })
	...
	@Test(expected = TimeLimitExceededException.class)
	@SmtpServer(timeout = 1000, waitFor = { @WaitFor(headers = @Header(key = "DoesNotExist", value = "")) })
